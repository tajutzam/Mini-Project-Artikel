                ...
                <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0 mt-10">
                    ...
                    <div
                        ...
                        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            @endif
                            <form class="space-y-4 md:space-y-6" action="{{url("penulis/register")}}" method="post">
                                @csrf
                                @method("post")
                                <div>
                                    <label for="email"
                                ...
                                <div class="flex items-center justify-between">
                                    <button class="w-full bg-blue-700 text-white hover:bg-blue rounded-sm p-2"
                                ...
                                <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                                    Sudah punya akun ? <a href="{{ url('penulis/login') }}"
