...
<nav class="fixed top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
        <div class="flex items-center justify-between">
            ...
            <div class="text-xl font-semibold text-blue-600/100 dark:text-blue-500/100">
                {{ Auth::guard('penulis')->user()->name }}</div>
        </div>
    </div>
</nav>
...
<aside id="logo-sidebar"
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{url("penulis/tulis-artikel")}}"
                    class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
...
<div class="p-4 sm:ml-64">
    <div class="p-4 border-2 border-gray-200 border-separate rounded-lg dark:border-gray-700 mt-14">
        @if ($errors->any())
